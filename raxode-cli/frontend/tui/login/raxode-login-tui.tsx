...
import { EMBEDDING_MODEL_CATALOG, listAvailableChatModels, probeEmbeddingModelAvailability } from "../input/model-catalog.js";
import {
...
} from "../login/raxode-login-wizard.js";
import { loadRaxodeAuthFile, loadRaxodeConfigFile, loadResolvedEmbeddingConfig } from "../config/raxode-config.js";
...
async function fetchChatModelAvailability(kind: MethodOption, fallbackDir: string): Promise<void> {
  if (kind === "anthropic") {
    ...
    const auth = loadRaxodeAuthFile(fallbackDir);
